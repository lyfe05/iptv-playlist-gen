...
# Configuration
OPENAI_API_KEY = os.getenv("OPENAI_API_KEY", "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")  # Use environment variable
EPG_URL = ""  # Example EPG source
LOGO_BASE_URL = ""  # Fallback logo source
